...
public class Lcscp15_v2 implements ISpecificationBuilder {
	static public Lcscp15_v2 INSTANCE = new Lcscp15_v2();
	private Lcscp15_v2 () {
		// SINGLETON
	}	
	...
	public static void main(String[] args) {
		String name = "scp15_v2";
		
		ReduceSpecificationBuilder INSTANCE = new ReduceSpecificationBuilder(Lcscp15_v2.INSTANCE);
