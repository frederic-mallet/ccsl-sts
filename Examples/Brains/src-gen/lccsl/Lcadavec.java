...
public class Lcadavec implements ISpecificationBuilder {
	...
	public void build(ISimpleSpecification simple, String Urban, String Highway, String interurban, String Sunny, String Night, String On, String Off) {
...
simple.addClock(Off);
	...
	public void build(ISimpleSpecification simple) {
		build(simple, "Urban", "Highway", "interurban", "Sunny", "Night", "On", "Off");
	}
