...
public class FactoryHelper {
	...
	public SynchronousTransitionSystem createSynchronousTransitionSystem(String name) {
	...
	public Transition createTransition(State source, State target, Event ...events) {
